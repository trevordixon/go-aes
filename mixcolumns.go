...
var mult2 multiplier = func(b byte) byte {
	m := [256]byte{
...
var mult3 multiplier = func(b byte) byte {
	m := [256]byte{
...
var mult9 multiplier = func(b byte) byte {
	m := [256]byte{
...
var mult11 multiplier = func(b byte) byte {
	m := [256]byte{
...
var mult13 multiplier = func(b byte) byte {
	m := [256]byte{
...
var mult14 multiplier = func(b byte) byte {
	m := [256]byte{
